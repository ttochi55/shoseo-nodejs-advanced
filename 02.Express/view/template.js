    ...
    return `
			<form action="/create" method="post">
				...
				<tr>
					...
					<td><input type="text" name="subject" minlength="2" placeholder="제목을 입력해 주세요." required></td>
				</tr>
				<tr>
					<td><label>내용</label></td>
					<td><textarea name="description" cols="40" rows="5" minlength="2" placeholder="내용을 입력해 주세요." required></textarea></td>
				</tr>
				<tr>
  ...
  updateForm: function (subject, description) {
    return `
			<form action="/update" method="post">
				...
				<tr>
					<td><label>제목</label></td>
					<td><input type="text" name="subject" value="${subject}" readonly style="border:1px solid #444;background-color:#eee;"></td>
				</tr>
				<tr>
					<td><label>내용</label></td>
